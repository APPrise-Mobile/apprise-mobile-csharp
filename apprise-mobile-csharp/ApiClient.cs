...
namespace AppriseMobile
{
    public class ApiClient : IDisposable
    {
        ...
        /// <summary>
        /// Upload a csv to add users to a single group
        /// </summary>
        /// <param name="filePath">Csv to upload</param>
        /// <param name="groupName">Name of the group to upload to</param>
        public void UploadSingleGroupCsv(string filePath, string groupName)
        {
            var otherParams = new Dictionary<string, string>
            {
                ["groupName"] = groupName
            };
            UploadFile("/users/single-csv", filePath, otherParams);
        }
